...
import 'features/api_key/modules/load_api_key_module.dart';
import 'features/auth/domain/entities/auth_user.dart';
import 'features/auth/module/auth_module.dart';
import 'features/chat/module/chat_page_module.dart';
import 'features/entrypoint/presentation/ui/splash_page.dart';
...
class AppModule extends Module {
  ...
  void routes(r) {
    ...
    r.module('/api-key', module: ApiKeyModule());
